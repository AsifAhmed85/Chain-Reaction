...
def init():
    ...
    p1 = subprocess.Popen(['ai.exe', 'R'], stdout=subprocess.PIPE, stdin=subprocess.PIPE,
                          universal_newlines=True, bufsize=1)
    p2 = subprocess.Popen(['player_1.exe', 'G'], stdout=subprocess.PIPE, stdin=subprocess.PIPE,
                          universal_newlines=True, bufsize=1)
